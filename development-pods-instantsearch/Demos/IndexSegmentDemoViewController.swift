...
class IndexSegmentDemoViewController: UIViewController, InstantSearchCore.HitsController {
  ...
  let indexTitle = DemoHelper.client.index(withName: "mobile_demo_movies")
  let indexYearAsc = DemoHelper.client.index(withName: "mobile_demo_movies_year_asc")
  let indexYearDesc = DemoHelper.client.index(withName: "mobile_demo_movies_year_desc")
